    ...
    return {
      ...
      setup(aibitat) {
        aibitat.function({
          ...
          name: this.name,
          description:
            "Create a text file for browser download only. " +
            "This tool does NOT write to the filesystem or any vault directory — it saves to internal temporary storage and delivers the file as a download. " +
            "Do NOT use this tool when the user wants to save a note, document, or file to their vault, Obsidian, or any directory on disk. " +
            "For writing files to the filesystem or a vault, use filesystem-write-text-file instead. " +
